...
@Module
public class OtpReasonCodeViewModel extends BaseViewModel<IReasonCodeNavigation> {
    ...
    public OtpReasonCodeViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider) {
    ...
    void hitVerifyApi(String otpCollection, long contact_no, Activity activity, ArrayList<Long> manifest_no, String reasonCode) {
