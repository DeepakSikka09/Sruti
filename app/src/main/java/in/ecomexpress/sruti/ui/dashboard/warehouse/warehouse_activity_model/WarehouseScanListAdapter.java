 ...
 */
public class WarehouseScanListAdapter extends RecyclerView.Adapter<WarehouseScanListAdapter.ViewHolder> {
    ...
    public WarehouseScanListAdapter(Context mContext) {
    ...
    @Override
    public WarehouseScanListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.custom_awb_view, parent, false);
        return new WarehouseScanListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(WarehouseScanListAdapter.ViewHolder holder, int position) {
