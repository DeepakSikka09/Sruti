...
/**
 * Created by deepak on 6/12/19.
 */
@Module
public class OtpVerficationViewModel extends BaseViewModel<IQrNavigator> {
    private boolean isAllChecked = false;

    public OtpVerficationViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider) {
        super(dataManager, schedulerProvider);
    }

    public LiveData<List<ReasonCodeList>> getPickupListToView() {
        return getDataManager().getPickupList(Constants.OTP_WISE_REASON_CODE);
    }
