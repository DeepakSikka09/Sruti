 ...
 */
@Module
public class WarehouseScanViewModel extends BaseViewModel<IHandOverNavigator> {
    ...
    long tempManifestNo=0;
    private final MediatorLiveData<List<Shipment_Detail>> total_data = new MediatorLiveData<>();

    public WarehouseScanViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider) {
    ...
    public MutableLiveData<List<Shipment_Detail>> getAwbDetailLiveData() {
        return total_data;
    }
...
*/
    ...
    public void ifAWBexists(long manifestNumber, long awbNumber, String status) {
                ...
                getDataManager().ifAWBexists(manifestNumber, awbNumber, status).subscribeOn(getSchedulerProvider().io()).
    ...
    public void callScanApi(String lastText, String cust_code, long manifest_no, String vehicle) {
        ...
        getDataManager()
                    ...
                    .subscribe(new Consumer<ScanResponse>() {
                        ...
                        public void accept(ScanResponse response) {
                            ...
                            WarehouseScanViewModel.this.setIsLoading(false);
...
//                            writeErrors(timeStamp, new Exception(throwable));
                            ...
                            if (error.contains("HTTP 500 ")) {
                                getNavigator().showErrorMessage("Internal Server Error");
                            } else {
//                                getNavigator().startLoginVeriyOTPActivity();
  ...
  /*  public void setBpIdReasonCode(List<ReasonCodeList> reasonCodeListList) {
